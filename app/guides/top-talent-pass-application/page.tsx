    ...
    <div className="article-layout shell">
      ...
      <article className="article-content">
        ...
        <div className="table-wrap"><table><thead><tr><th>类别</th><th>核心条件</th><th>首次逗留</th><th>年度配额</th></tr></thead><tbody>
          <tr><td><b>A类</b></td><td>紧接申请前一年，全年收入达到港币250万元或等值外币</td><td>36个月</td><td>官方未列明</td></tr>
          <tr><td><b>B类</b></td><td>获合资格大学颁授学士学位，并在申请前五年内累计至少三年毕业后全职或自雇工作经验</td><td>24个月</td><td>官方未列明</td></tr>
          <tr><td><b>C类</b></td><td>在申请前五年内获合资格大学学士学位，工作经验少于三年</td><td>24个月</td><td>有，先到先得</td></tr>
        </tbody></table></div>
        <p className="note">符合类别要求不等于一定获批。最终仍由香港入境事务处按个案审批。</p>
