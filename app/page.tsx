...
export default function Home() {
  ...
  return (
    <main>
      ...
      <section className="talent-guides shell" id="talent-guides">
        <div className="talent-feature">
          <div className="talent-feature-copy">
            <span className="section-kicker">TALENT APPLICATION</span>
            <span className="article-status">最新攻略 · 2026年7月核对</span>
            <h2>香港高才通申请指南</h2>
            <p>从A、B、C类资格判断，到材料、费用、网上递交和获批后的下一步，一篇讲清楚。</p>
            <div className="talent-topics"><span>A/B/C类判断</span><span>材料清单</span><span>申请费用</span><span>受养人安排</span></div>
            <a className="talent-read" href="/guides/top-talent-pass-application">阅读完整攻略 <span>→</span></a>
          </div>
